import {LinearTransfer, Matrix3, SRGBTransfer} from '../../libs/three/Three.js';
...
const LINEAR_DISPLAY_P3_TO_XYZ = new Matrix3().set(
    0.4865709, 0.2656677, 0.1982173,
    0.2289746, 0.6917385, 0.0792869,
    0.0000000, 0.0451134, 1.0439444
);

const XYZ_TO_LINEAR_DISPLAY_P3 = new Matrix3().set(
...
const LINEAR_REC2020_TO_XYZ = new Matrix3().set(
    0.6369580, 0.1446169, 0.1688810,
    0.2627002, 0.6779981, 0.0593017,
    0.0000000, 0.0280727, 1.0609851
);

const XYZ_TO_LINEAR_REC2020 = new Matrix3().set(
